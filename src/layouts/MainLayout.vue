      ...
      <div class="px-6 pt-4">
        ...
        >
          <div class="flex items-center">
            <img
              src="@/assets/favicon/santrimaster-icon.jpeg"
              width="42"
              class="rounded-full"
              alt="SantriMaster Logo"
            />
            <div class="ms-2 text-base dark:text-white">
              Santri
              <span class="text-white bg-[#182463] px-3 rounded-2xl"
                >Master</span
              >
              <div class="text-xs font-normal">Powered by Al-Hidayah 2</div>
            </div>
          </div>
        </a>
        <!-- End Logo -->
          ...
          <ul class="flex flex-col space-y-1">
            ...
            <li class="hs-accordion" id="users-accordion">
              ...
              >
                ...
                <i
                  class="bx bx-minus hs-accordion-active:block ms-auto hidden size-4"
                ></i>
                <i
                  class="bx bx-plus hs-accordion-active:hidden ms-auto block size-4"
                ></i>
              </button>
                ...
                <ul class="ps-8 pt-1 space-y-1">
                  <li>
                    <router-link
                      ...
                      to="/user/input"
                    >
                      <i class="bx bx-radio-circle"></i> Input User
                    </router-link>
                  </li>
                  <li>
                    <router-link
                      ...
                      to="/user"
                    >
                      <i class="bx bx-radio-circle"></i> Data User
                    </router-link>
                  </li>
                  <li>
                    <router-link
                      ...
                      to="/user/user"
                    >
                      <i class="bx bx-radio-circle"></i> Data percobaan
                    </router-link>
                  </li>
                </ul>
              </div>
            </li>
            <li class="hs-accordion" id="rooms-accordion">
              <button
                type="button"
                class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-200"
                aria-expanded="true"
                aria-controls="rooms-accordion-child"
              >
              ...
              <div
                id="rooms-accordion-child"
                class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden"
                role="region"
                aria-labelledby="rooms-accordion"
              >
                <ul class="ps-8 pt-1 space-y-1">
                  <li>
                    <router-link
                      ...
                      to="/room/input"
                    >
                      <i class="bx bx-radio-circle"></i> Input Room
                    </router-link>
                  </li>
                  <li>
                    <router-link
                      ...
                      to="/room"
                    >
                      <i class="bx bx-radio-circle"></i> Data Room
                    </router-link>
                  </li>
                </ul>
              </div>
